...
if __name__ == "__main__":
    ...
    output_folder = '0628_1705_logs/'
    model_name = 'glow_checkpoint_56250.pt'
    ...
    for p in range(len(face_pair)):
        ...
        for i,(x,y) in enumerate(test_loader):
            ...
            if i == face_pair[p][1] :
                x2, y2 = x, y
                break
        print("x1,y1,x2,y2 ready")
        print('y1: ', y1)
        print('y2: ', y2)
        z1, _, _ = model(x1, y1)  # return: z, bpd, y_logits
        z2, _, _ = model(x2, y2)  # return: z, bpd, y_logits
        z1 = z1.cpu()
        z2 = z2.cpu()
        print('z1[0]: ', z1.shape)
    ...
    save_image(interpolation_result, 'images/task2_interpolation.png', normalize=True)
